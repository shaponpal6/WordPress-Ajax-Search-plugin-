WPArtificialSB.prototype.common = (function () {
    "use strict";
    var isCancel = false;
    ...
    function aisBot(target) {
        ...
        console.log(target.parentNode.dataset.aisbId);
        let aid
        try {
            aid = target.offsetParent.dataset.aisbId;
        }catch (e) {
            aid = target.parentNode.dataset.aisbId;
        }
